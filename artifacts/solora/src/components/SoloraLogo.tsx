...
export default function SoloraLogo({ variant = "dark", size = 48 }: SoloraLogoProps) {
  const strokeColor = variant === "light" ? "#ffffff" : "#1A1714";
  ...
  return (
    <motion.div
      ...
      whileHover={{ rotateZ: 3, transition: { duration: 0.4, ease: "easeOut" } }}
    >
      <svg
        width={size * 0.8}
        height={size}
